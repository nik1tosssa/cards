...
│      ГЛАВНАЯ СТРАНИЦА               │
│         index.html                  │
│  Выбор активности (кнопки)          │
└────────────────┬────────────────────┘
        ↓        ↓
    ┌───┴──┐  ┌──┴───┐
    │      │  │      │
 pages/   pages/
matches/  fortune_wheel/
matches   fortune_wheel
.html     .html
    │      │
    └──┬───┘
...
## Архитектура Соотнеси карточки (pages/matches/matches.html)

```
┌─────────────────────────────────────────────────────┐
│       pages/matches/matches.html                    │
...
## Архитектура Колеса Фортуны (pages/fortune_wheel/fortune_wheel.html)

```
┌─────────────────────────────────────────────┐
│   pages/fortune_wheel/fortune_wheel.html   │
